...
using SalesForcePublish.Models;

namespace SalesForcePublish
{
    ...
    class Program
    {
        ...
        private static async Task RunTest()
        {
            ...
            try
            {
                ...
                var contact = new Contact() { Salutation = "Mr", FirstName = "Testing", LastName = "Test", Email = "TestEmail@abc.com" };
                var id = await client.CreateRecord<Contact>("Contact", contact);
